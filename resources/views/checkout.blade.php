              ...
              <div class="col-md-4">
                <div class="checkout-right">
                    ...
                    <table class="table table-responsive">
                      ...
                      <tfoot>
                        <tr>
                         ...
                         <tr>
                          <th>Total</th>
                          <td>RM{{ number_format(Cart::getTotal() + 5, 2)}}</td>
                        </tr>
                      </tfoot>
                    </table>
                  </div>
                  ...
                  <div class="aa-payment-method">                    
                    ...
                    <form action="{{ route('cart.clear') }}" method="POST" enctype="multipart/form-data" id="delete-form">
                      @csrf
                      <!-- <input type="submit" value="Place Order" class="aa-browse-btn" href="javascript:;" onclick="parentNode.submit();">     -->
                      <a class="aa-browse-btn" href="javascript:;" onclick="placeOrder();" onclick="parentNode.submit();">Place Order</a>
                    </form>            
                  </div>
                </div>
              </div>
