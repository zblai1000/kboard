                  ...
                  <div class="aa-product-view-slider">                                
                    <div id="demo-1" class="simpleLens-gallery-container">
                      ...
                      <div class="simpleLens-thumbnails-container">
                          <a data-big-image="/uploads/products/{{$product ->main_image}}" data-lens-image="{{ URL::asset('uploads/products/testImageLarge.jpg') }}" class="simpleLens-thumbnail-wrapper" href="#">
                            <img src="/uploads/products/{{$product ->tumbnail_main_image}}">
                          </a>                                    
                          <a data-big-image="/uploads/products/{{$product ->sub_image_1}}" data-lens-image="{{ URL::asset('uploads/products/testImageLarge.jpg') }}" class="simpleLens-thumbnail-wrapper" href="#" style="display: {{$product->display_1}}">
                            <img src="/uploads/products/{{$product ->tumbnail_sub_image_1}}" style="display: {{$product->tumbnail_display_1}}">
                          </a>
                          <a data-big-image="/uploads/products/{{$product ->sub_image_2}}" data-lens-image="{{ URL::asset('uploads/products/testImageLarge.jpg') }}" class="simpleLens-thumbnail-wrapper" href="#" style="display: {{$product->display_2}}">
                            <img src="/uploads/products/{{$product ->tumbnail_sub_image_2}}" style="display: {{$product->tumbnail_display_2}}">
                          </a>
                          <a data-big-image="/uploads/products/{{$product ->sub_image_3}}" data-lens-image="{{ URL::asset('uploads/products/testImageLarge.jpg') }}" class="simpleLens-thumbnail-wrapper" href="#" style="display: {{$product->display_3}}">
                            <img src="/uploads/products/{{$product ->tumbnail_sub_image_3}}" style="display: {{$product->tumbnail_display_3}}">
                          </a>
                          <a data-big-image="/uploads/products/{{$product ->sub_image_4}}" data-lens-image="{{ URL::asset('uploads/products/testImageLarge.jpg') }}" class="simpleLens-thumbnail-wrapper" href="#" style="display: {{$product->display_4}}">
                            <img src="/uploads/products/{{$product ->tumbnail_sub_image_4}}" style="display: {{$product->tumbnail_display_4}}">
                          </a>
                          <a data-big-image="/uploads/products/{{$product ->sub_image_5}}" data-lens-image="{{ URL::asset('uploads/products/testImageLarge.jpg') }}" class="simpleLens-thumbnail-wrapper" href="#" style="display: {{$product->display_5}}">
                  ...
                  <div class="aa-product-view-content">
                    ...
                    <div class="aa-prod-quantity">
                      ...
                      <p class="aa-prod-category">
                        Category: <a href="#">K100 Keyboard</a>
                      </p>
                    </div>
